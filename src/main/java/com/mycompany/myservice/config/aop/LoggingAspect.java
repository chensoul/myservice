package com.mycompany.myservice.config.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.mycompany.myservice..*.*Repository)" + " || within(com.mycompany.myservice..*.*Service)"
            + " || within(com.mycompany.myservice..*.*Controller)")
